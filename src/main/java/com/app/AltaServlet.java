...
public class AltaServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
    	...
    	// 1. Capturar par�metros del formulario (autor, comentario).
        ...
        try {
         ...
         resultado2 = Integer.parseInt(request.getParameter("resultado2"));
            ...
            // Si no son n�meros v�lidos, ir a la p�gina de error
     ...
     // 2. Validar que no est�n vac�os.
        if (equipo1 == null || equipo1.isBlank() || equipo2 == null || equipo2.isBlank() || resultado1 < 0 || resultado2 < 0) {
            // Si alg�n campo es inv�lido, ir a la p�gina de error
            request.getRequestDispatcher("/vistas/error.jsp").forward(request, response);
            return;
        }
     ...
     // Paso 1: conectar con la base de datos
        ...
        try {
	    	...
	    	// la variable entera "filas" ser� igual a 1 si se cre� un dato, o 0 si no se cre� nada.
            int filas = declaracionPreparada.executeUpdate();

            // Paso 6: verificar si se insert� correctamente
            if (filas > 0) {
