...
@WebServlet("/Leer2")
public class LeerServlet2 extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            try (ResultSet conjuntoJugadores2 = declaracion.executeQuery(sql)) {

                request.setAttribute("conjuntoJugadores2", conjuntoJugadores2);
                request.getRequestDispatcher("vistas/tablajugadores2.jsp").forward(request, response);
            }
