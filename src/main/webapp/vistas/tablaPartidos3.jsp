...
<body>
	...
	<div class="contenedor">
		...
		<%
		ResultSet conjuntoPartidos3 = (ResultSet) request.getAttribute("conjuntoPartidos3");

		int contador = 1;

		if (conjuntoPartidos3 != null && conjuntoPartidos3.next()) {

			do {

				int id = conjuntoPartidos3.getInt("id");
				int id_local = conjuntoPartidos3.getInt("id_local");
				int id_visitante = conjuntoPartidos3.getInt("id_visitante");

				int puntos_local = conjuntoPartidos3.getInt("puntos_local");

				int puntos_visitante = conjuntoPartidos3.getInt("puntos_visitante");

				int id_deporte = conjuntoPartidos3.getInt("id_deporte");

				String curso = conjuntoPartidos3.getString("curso");
		%>
		...
		<!-- BOTÓN ELIMINAR -->
		<form action="${pageContext.request.contextPath}/eliminarPartido3"
		...
		<button type="button"
			onclick="window.location.href='${pageContext.request.contextPath}/vistas/editarPartido3.jsp?id=<%=id%>'"
