...
<div class="form-container">
    ...
    <form action="${pageContext.request.contextPath}/editarPartido"
          method="post">
        ...
        <div class="button-container">
            <a href="${pageContext.request.contextPath}/LeerTabla"
               class="submit-button link-button">
               Volver
            </a>
        </div>
