...
<div class="form-container">
    ...
    <form action="${pageContext.request.contextPath}/editarJugador2"
          method="post">
       ...
       <input type="hidden" name="id" value="${param.id}">
        ...
        <div class="form-group">
            ...
            <select name="curso" required class="form-input">
                ...
                <option value="3TGAO" ${curso=='3TGAO'?'selected':''}>3TGAO</option>
                <option value="3TME" ${curso=='3TME'?'selected':''}>3TME</option>
                <option value="3TC" ${curso=='3TC'?'selected':''}>3TC</option>
                <option value="3BACHI" ${curso=='3BACHI'?'selected':''}>3BACHI</option>

                <option value="4TGAO" ${curso=='4TGAO'?'selected':''}>4TGAO</option>
                <option value="4TME" ${curso=='4TME'?'selected':''}>4TME</option>
                <option value="4TC" ${curso=='4TC'?'selected':''}>4TC</option>
                <option value="4BACHI" ${curso=='4BACHI'?'selected':''}>4BACHI</option>
            </select>
        </div>
